...
async function run() {
    const parts = [
        ...
        { text: "input: a json data that contains words and some details of these words {    \"data\": [        {            \"word\": \"suýt\",            \"_word\": \"suyt\",            \"description\": \"Chỉ còn thiếu chút nữa là đã xảy ra (thường là điều không hay).\",            \"tl\": \"Phụ từ\"        },        {            \"word\": \"vẫn\",            \"_word\": \"van\",            \"description\": \"Từ biểu thị ý khẳng định về điều xảy ra, diễn ra như bình thường, cho dù điều kiện là không bình thường.\",            \"tl\": \"Phụ từ\"        }    ]}" },
        { text: "output: add  \"synset_vi\" field that contains synonym and same class words with \"wordd\" field " },
    ];
