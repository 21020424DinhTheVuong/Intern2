...
async function run() {
    const parts = [
        ...
        { text: "input: a json data that contains words and some details of these words {    \"data\": [        {            \"word\": \"suỵt\",            \"_word\": \"suyt\",            \"description\": \"Tiếng gió thốt ra khe khẽ để nhắc người khác giữ im lặng.\",            \"tl\": \"Cảm từ\"        }    ]}" },
        { text: "output: add  \"synset_vi\" field that contains synonym and same class words with \"wordd\" field " },
    ];
