...
async function run() {
    const parts = [
        ...
        { text: "input: a json data that contains words and some details of these words {    \"data\": [        {            \"word\": \"ham chơi\",            \"_word\": \"ham choi\",            \"description\": \"\",            \"tl\": \"Ngữ tính từ\"        },        {            \"word\": \"khó tiêu\",            \"_word\": \"kho tieu\",            \"description\": \"\",            \"tl\": \"Ngữ tính từ\"        }    ]}" },
        { text: "output: add  \"synset_vi\" field that contains synonym and same class words with \"wordd\" field " },
    ];
