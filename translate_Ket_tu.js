...
async function run() {
    const parts = [
        ...
        { text: "input: a json data that contains words and some details of these words {    \"data\": [        {            \"word\": \"nhưng\",            \"_word\": \"nhung\",            \"description\": \"Từ biểu thị điều sắp nêu ra ngược lại với điều vừa nói.\",            \"tl\": \"Kết từ\"        }    ]}" },
        { text: "output: add  \"synset_vi\" field that contains synonym and same class words with \"wordd\" field " },
    ];
