...
async function run() {
    const parts = [
        ...
        { text: "input: a json data that contains words and some details of these words {    \"data\": [        {            \"word\": \"còn bạn?\",            \"_word\": \"con ban?\",            \"description\": \"\",            \"tl\": \"Câu hỏi\"        },        {            \"word\": \"mệt không?\",            \"_word\": \"met khong?\",            \"description\": \"\",            \"tl\": \"Câu hỏi\"        }    ]}" },
        { text: "output: add  \"synset_vi\" field that contains synonym and same class words with \"wordd\" field " },
    ];
