...
async function run() {
    const parts = [
        ...
        { text: "input: a json data that contains words and some details of these words {    \"data\": [        {            \"word\": \"bạn yêu tôi\",            \"_word\": \"ban yeu toi\",            \"description\": \"\",            \"tl\": \"Câu\"        },        {            \"word\": \"bạn ấy yêu tôi\",            \"_word\": \"ban ay yeu toi\",            \"description\": \"\",            \"tl\": \"Câu\"        },        {            \"word\": \"bạn yêu bạn ấy\",            \"_word\": \"ban yeu ban ay\",            \"description\": \"\",            \"tl\": \"Câu\"        },        {            \"word\": \"bạn ấy yêu bạn\",            \"_word\": \"ban ay yeu ban\",            \"description\": \"\",            \"tl\": \"Câu\"        },        {            \"word\": \"đất nước bị chia cắt (Việt Nam)\",            \"_word\": \"dat nuoc bi chia cat (viet nam)\",            \"description\": \"\",            \"tl\": \"Câu\"        }    ]}" },
        { text: "output: add  \"synset_vi\" field that contains synonym and same class words with \"wordd\" field " },
    ];
