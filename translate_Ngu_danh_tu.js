...
async function run() {
    const parts = [
        ...
        { text: "input: a json data that contains words and some details of these words {    \"data\": [        {            \"word\": \"mỗi ngày\",            \"_word\": \"moi ngay\",            \"description\": \"\",            \"tl\": \"Ngữ danh từ\"        },        {            \"word\": \"mồ hôi nhễ nhại\",            \"_word\": \"mo hoi nhe nhai\",            \"description\": \"\",            \"tl\": \"Ngữ danh từ\"        }    ]}" },
        { text: "output: add  \"synset_vi\" field that contains synonym and same class words with \"wordd\" field " },
    ];
