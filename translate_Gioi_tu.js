...
async function run() {
    const parts = [
        ...
        { text: "input: a json data that contains words and some details of these words {    \"data\": [        {            \"word\": \"cũng vậy/cũng thế\",            \"_word\": \"cung vay/cung the\",            \"description\": \"\",            \"tl\": \"Giới từ\"        },        {            \"word\": \"cùng / với (giới từ)\",            \"_word\": \"cung / voi (gioi tu)\",            \"description\": \"\",            \"tl\": \"Giới từ\"        }    ]}" },
        { text: "output: add  \"synset_vi\" field that contains synonym and same class words with \"wordd\" field " },
    ];
