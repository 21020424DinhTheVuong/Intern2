...
async function run() {
    const parts = [
        ...
        { text: "input: a json data that contains words and some details of these words {    \"data\": [        {            \"word\": \"quanh năm\",            \"_word\": \"quanh nam\",            \"description\": \"Suốt từ đầu năm đến cuối năm.\",            \"tl\": \"Trạng từ\"        },        {            \"word\": \"đằng sau\",            \"_word\": \"dang sau\",            \"description\": \"\",            \"tl\": \"Trạng từ\"        },        {            \"word\": \"đằng trước\",            \"_word\": \"dang truoc\",            \"description\": \"\",            \"tl\": \"Trạng từ\"        }    ]}" },
        { text: "output: add  \"synset_vi\" field that contains synonym and same class words with \"wordd\" field " },
    ];
